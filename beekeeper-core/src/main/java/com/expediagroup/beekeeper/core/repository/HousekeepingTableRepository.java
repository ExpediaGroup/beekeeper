...
public interface HousekeepingTableRepository extends JpaRepository<EntityHousekeepingTable, Long> {
  ...
  @Query(value = "select t from EntityHousekeepingTable t "
      + "where t.databaseName = :databaseName "
      + "and t.tableName = :tableName "
      + "and (t.housekeepingStatus = 'SCHEDULED' or t.housekeepingStatus = 'FAILED')")
  Optional<EntityHousekeepingTable> findRecordForCleanupByDatabaseAndTable(@Param("databaseName") String databaseName,
