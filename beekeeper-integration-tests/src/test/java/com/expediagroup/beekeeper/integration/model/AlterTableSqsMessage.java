...
public class AlterTableSqsMessage extends SqsMessage {
  ...
  public AlterTableSqsMessage(
      String tableLocation, String oldTableLocation, boolean isUnreferenced, boolean isWhitelisted)
  ...
  public AlterTableSqsMessage(String tableLocation, boolean isExpired)
      throws IOException, URISyntaxException {
    super(ALTER_TABLE);
    setTableLocation(tableLocation);
  ...
  public void setOldTableLocation(String oldTableLocation) {
    apiaryEventMessageJsonObject.add(
        EVENT_TABLE_OLD_LOCATION_KEY, new JsonPrimitive(oldTableLocation));
  }
