...
public class ExpiredPathMapperTest {
    ...
    public void shouldProperlyDefaultIfEventExpirationInvalid() {
        ...
        MapperTestUtils.assertPath(path, DEFAULT_EXPIRED_CLEANUP_DELAY, TABLE, DATABASE, CLEANUP_ATTEMPTS, CREATION_TIMESTAMP, OLD_PATH, EXPIRED);
    }
    ...
    public void typicalMapAlterPartitionEvent() {
        ...
        MapperTestUtils.assertPath(path, CLEANUP_EXPIRED_DELAY, TABLE, DATABASE, CLEANUP_ATTEMPTS, CREATION_TIMESTAMP, OLD_PATH, EXPIRED);
    }
    ...
    public void typicalMapCreateTableEvent() {
        ...
        MapperTestUtils.assertPath(path, CLEANUP_EXPIRED_DELAY, TABLE, DATABASE, CLEANUP_ATTEMPTS, CREATION_TIMESTAMP, PATH, EXPIRED);
    }
