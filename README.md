...
|:----|:----:|:----|
| `path`                   | Given a path name, return if there is a path with that name | `/database/my_database_name`<br>`/table/my_table_name/metadata`<br>`?path=s3://mybucket/mydb/mytable/myfile.part1` |
