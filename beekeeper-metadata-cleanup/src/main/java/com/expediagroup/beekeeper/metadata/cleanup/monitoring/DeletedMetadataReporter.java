...
public class DeletedMetadataReporter {
  ...
  // TODO
  // How is this tag going to come out?
  // Do we want the table name of the tag to be included?
  public void reportTaggable(Taggable taggable, String databaseName) {
    ...
    Counter counter = Counter.builder(databaseMetricName).tags(tags(taggable.getMetricTag())).register(meterRegistry);
    counter.increment();
  }
