...
import static com.expediagroup.beekeeper.core.config.MetadataType.HIVE_TABLE;
...
public class DeletedMetadataReporterTest {
  ...
  private String tableCounterName = String.join("-", HIVE_TABLE.getTypeName(), METRIC_NAME);
  private String dryRunTableCounterName = String
      .join("-", HIVE_TABLE.getTypeName(), DRY_RUN_METRIC_NAME);
  ...
  @Test
  public void typical() {
    deletedMetadataReporter.reportTaggable(taggable, HIVE_TABLE);
  ...
  public void multipleTablesDeleted() {
    ...
    deletedMetadataReporter.reportTaggable(taggable, HIVE_TABLE);
    deletedMetadataReporter.reportTaggable(taggable2, HIVE_TABLE);
